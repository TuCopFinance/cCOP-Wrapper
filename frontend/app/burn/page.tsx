    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-900 via-blue-400 to-yellow-300 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center pt-32 pb-12">
        <div className="w-full max-w-lg bg-white/90 rounded-3xl shadow-2xl p-10 flex flex-col items-center border border-blue-100">
          <h1 className="text-3xl font-bold text-blue-900 mb-4 text-center drop-shadow">Redimir wCOP (Base → Celo)</h1>
          <label className="mb-2 text-blue-800 font-medium w-full text-left">Cantidad a redimir</label>
          ...
          <button onClick={handleBurn} className="mb-4 px-8 py-3 bg-gradient-to-r from-blue-700 to-yellow-400 text-white font-bold rounded-xl shadow-lg hover:from-blue-800 hover:to-yellow-500 transition text-lg">Redimir</button>
