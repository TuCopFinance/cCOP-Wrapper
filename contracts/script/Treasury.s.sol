...
contract TreasuryScript is Script {
    ...
    address public constant MAILBOX_CELO_ALFAJORES =
        0xEf9F292fcEBC3848bF4bB92a96a04F9ECBb78E59; // Mailbox for Celo Alfajores (testnet)
    address public constant MAILBOX_CELO_MAINNET =
        0x50da3B3907A08a24fe4999F4Dcf337E8dC7954bb; // Mailbox for Celo Mainnet
    address public constant MAILBOX_ARB_MAINNET =
        0x979Ca5202784112f4738403dBec5D0F3B9daabB9; // Mailbox for Arbitrum Mainnet
    address public constant MAILBOX_ARB_TESTNET =
        0x598facE78a4302f11E3de0bee1894Da0b2Cb71F8; // Mailbox for Arbitrum Testnet
    address public constant CCOP_CELO_ALFAJORES =
        0xeF760Ba3281205ec8baB0E63Be0c74a734D11825; // cCOP address for Celo Alfajores (testnet)
    address public constant CCOP_CELO_MAINNET =
