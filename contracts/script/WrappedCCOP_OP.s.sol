...
contract WrappedCCOP_OP_Script is Script {
    WrappedCCOP public wrappedCCOP;

    address public constant OWNER = 0x5cBf2D4Bbf834912Ad0bD59980355b57695e8309;

    address public constant MAILBOX_OP_SEPOLIA =
        0x6966b0E55883d49BFB24539356a2f8A673E02039; // Mailbox for Base Sepolia (testnet)
    address public constant MAILBOX_OP_MAINNET =
        0xd4C1905BB1D26BC93DAC913e13CaCC278CdCC80D; // Mailbox for Base Mainnet
